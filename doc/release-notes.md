...
- openssl-1.0.1k or older versions patched for CVE-2014-8275 broke compatibility with Bitcoin and BitcoinHasHCore.
  This update patches BitcoinHasHCore to maintain compatibility with CVE-2014-8275 patched openssl.
- If you are running v0.8.7.4 as distributed by bitcoinhashcore.org you do not need to upgrade.
  The binaries distributed on bitcoinhashcore.org contain their own copy of openssl so they are unaffected by this issue.
...
- Minor fixes:
  - s/Bitcoin/BitcoinHasHCore/ in the Coin Control example
...
- Internal miner added back to BitcoinHasHCore.  setgenerate now works, although it is generally a bad idea as it is significantly slower than external CPU miners.
...
Fix out-of-bounds check (BitcoinHasHCore currently does not use this codepath, but we apply this
