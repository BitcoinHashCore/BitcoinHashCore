...
Setup
-----
Unpack the files into a directory and run bitcoinhashcore-qt.exe.

BitcoinHasHCore-Qt is the original BitcoinHasHCore client and it builds the backbone of the network.
